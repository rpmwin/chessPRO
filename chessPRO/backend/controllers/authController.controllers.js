...
export const googleCallback = async (req, res, next) => {
  try {
    ...
    console.log("hey this is for testing222");

    const sst = `${process.env.CLIENT_HOME_URL}/oauth-success?accessToken=${accessToken}`;

    console.log("redirecting to heere: ", sst);

    res
      .cookie("jid", refreshToken, COOKIE_OPTIONS)
      .redirect(
